...
function checkUnameLen() {
    ...
    if (uname.length < 3) {
        ...
        document.getElementById("uname_error").innerHTML =
            "<span style='color: white;'>&#10006 Username must be at least 3 alphanumeric characters. </span>";
        return false;
    }
...
function checkUnameChar() {
    ...
    if (!uname.match(uname_char)) {
        ...
        document.getElementById("uname_char_error").innerHTML =
            "<span style='color: white;'>&#10006 Username must start with a character (a-z or A-Z). </span>";
        return false;
    }
    document.getElementById("uname").style.borderColor = "green";
    document.getElementById("uname_char_error").innerHTML =
...
function checkPwdLen() {
    ...
    if (pwd.length < 8) {
        document.getElementById("pwd").style.borderColor = "white";
        document.getElementById("pwd_error").style.display = "block";
        document.getElementById("pwd_error").innerHTML =
            "<span style='color: white;'>&#10006 Password must be 8 characters long.</span>";
        return false;
    }
...
function checkPwdChar() {
    ...
    if (!pwd.match(pwd_char)) {
        ...
        document.getElementById("pwd_char_error").innerHTML =
            "<span style='color: white;'>&#10006 Password must contain at least 1 upper case letter and 1 number and 1 of the following special characters ( / * - + ! @ # $ ^ & * ).</span>";
        return false;
    }
    document.getElementById("pwd").style.borderColor = "green";
    document.getElementById("pwd_char_error").innerHTML =
...
function checkcPwdMatch() {
    ...
    if (pwd !== c_pwd || c_pwd == "") {
        document.getElementById("c_pwd").style.borderColor = "white";
        document.getElementById("c_pwd_error").style.display = "block";
        document.getElementById("c_pwd_error").innerHTML =
            "<span style='color: white;'>&#10006 Passwords must not be empty and must be identical.</span>";
        return false;
    }
